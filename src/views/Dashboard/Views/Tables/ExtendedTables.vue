        ...
        <div class="card">
          ...
          <div class="table-responsive">
            ...
            >
              ...
              <el-table-column min-width="80" class="td-price" label="Price">
                <template slot-scope="props">
              ...
              >
                <template slot-scope="props">
                  ...
                  <div class="btn-group">
                    ...
                    <button class="btn btn-sm" @click="props.row.quantity++">
                      <i class="ti-plus"></i>
                    </button>
                  </div>
                </template>
