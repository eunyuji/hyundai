          ...
          <div class="card-content">
            <vue-tabs class="row" direction="vertical" value="Description">
              <v-tab title="Info"
                ...
                <p>
                  It’s one continuous form where hardware and software function
                  in perfect unison, creating a new generation of phone that’s
              ...
              <v-tab title="Description">
                ...
                <p>
                  There are no distinct edges. No gaps. Just a smooth, seamless
                  bond of metal and glass that feels like one continuous
                  surface.
                </p>
              </v-tab>
              ...
              <v-tab title="Extra">
                ...
                meets the new Retina HD display. It’s one continuous form where
                hardware and software function in perfect unison, creating a new
