<template>
  <div class="row">
    ...
    <div class="col-lg-6 col-sm-6">
      <chart-card
        :chart-data="subscriptionsChart.data"
        :chart-options="subscriptionsChart.options"
      >
        <span slot="title">169</span>
        <span slot="title-label" class="label label-danger"> -14% </span>
        <h6 slot="subtitle">
          total subscriptions <span class="text-muted">in last</span> 7 days
        </h6>

        <div slot="footer-title">View all members</div>
        <button
          slot="footer-right"
          class="btn btn-default btn-fill btn-icon btn-sm"
        >
    ...
    <div class="col-lg-6 col-sm-6">
      <chart-card
        :chart-data="downloadsChart.data"
        :chart-options="downloadsChart.options"
      >
        <span slot="title">8,960</span>
        <span slot="title-label" class="label label-warning"> ~51% </span>
        <h6 slot="subtitle">
          total downloads <span class="text-muted">in last</span> 6 years
        </h6>

        <div slot="footer-title">View more details</div>
        <button
          slot="footer-right"
          class="btn btn-success btn-fill btn-icon btn-sm"
        >
          <i class="ti-info"></i>
        </button>
      </chart-card>
      ...
      <div class="card card-chat">
        ...
        <div class="card-content">
          <ol class="chat">
            ...
            <li class="self">
              <div class="msg">
                <p>Puff... I'm alright. How are you?</p>
                <div class="card-footer">
                  <i class="ti-check"></i>
                  <h6>11:22</h6>
                </div>
              ...
              <div class="avatar">
                <img src="/img/default-avatar.png" alt="crash" />
              </div>
            </li>
            <li class="other">
              <div class="avatar">
            ...
            <li class="self">
              <div class="msg">
                <p>Well, it was nice hearing from you.</p>
                <div class="card-footer">
                  <i class="ti-check"></i>
                  <h6>11:25</h6>
                </div>
