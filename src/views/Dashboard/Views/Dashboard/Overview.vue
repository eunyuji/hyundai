  ...
  <div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6">
        <chart-card
          :chart-data="earningsChart.data"
          :chart-options="earningsChart.options"
        >
          <span slot="title">$34,657</span>
          <span slot="title-label" class="label label-success"> +18% </span>
          <h6 slot="subtitle">
            total earnings <span class="text-muted">in last</span> ten
            <span class="text-muted">quarters</span>
          </h6>
          <div slot="footer-title">Financial Statistics</div>
          <button
            slot="footer-right"
            class="btn btn-info btn-fill btn-icon btn-sm"
          >
            <i class="ti-plus"></i>
          </button>
        </chart-card>
...
import Loading from '@/views/Dashboard/Layout/LoadingMainPanel.vue';
