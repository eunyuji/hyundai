          ...
          <form method="get" action="/" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <p-checkbox v-model="checkboxes.first"
                    >First checkbox</p-checkbox
                  >
                  <p-checkbox v-model="checkboxes.second"
                    >Second checkbox</p-checkbox
                  >

                  <p-radio label="1" v-model="radios.radio1"
                    >First Radio</p-radio
                  >
                  <p-radio label="2" v-model="radios.radio1"
                    >Second Radio</p-radio
                  >
                </div>
              </div>
            </fieldset>
            ...
            <fieldset>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <p-checkbox v-model="checkboxes.a" :inline="true"
                    >a</p-checkbox
                  >
                  <p-checkbox v-model="checkboxes.b" :inline="true"
                    >b</p-checkbox
                  >
                  <p-checkbox v-model="checkboxes.c" :inline="true"
                    >c</p-checkbox
                  >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4 col-sm-offset-1">
                  ...
                  <p-checkbox
                    ...
                    :disabled="true"
                    >Disabled checked</p-checkbox
                  >
                </div>

                <div class="col-sm-5">
                  <p-radio label="1" v-model="radios.radio2"
                    >Radio is off</p-radio
                  >
                  <p-radio label="2" v-model="radios.radio2"
                    >Radio is on</p-radio
                  >

                  <p-radio label="1" v-model="radios.radio2" :disabled="true"
                    >Disabled radio is off</p-radio
                  >
                  <p-radio label="2" v-model="radios.radio2" :disabled="true"
                    >Disabled radio is on</p-radio
                  >
                </div>
              </div>
            </fieldset>
