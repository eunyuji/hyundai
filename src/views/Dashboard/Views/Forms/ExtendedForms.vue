      ...
      <div class="card-content">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <p-checkbox disabled :checked="false"
          ...
          <div class="col-sm-3">
            ...
            <p-radio disabled v-model="disabledRadio" label="1"
              >Disabled radio is off</p-radio
            >
            <p-radio disabled v-model="disabledRadio" label="2"
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <el-slider class="slider-success" v-model="sliders.simple">
            </el-slider>
            <br />
            <el-slider
              class="slider-info"
