<template>
  <div>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <router-link class="navbar-brand" to="/admin"
            >Paper Dashboard PRO</router-link
          >
        </div>
    ...
    <div class="wrapper wrapper-full-page">
      <div
        class="full-page lock-page"
        data-color="green"
        data-image="/img/background/background-5.png"
        style="background-image: url('/img/background/background-5.png')"
      >
        ...
        <div class="content">
          <form method="#" action="#">
            <div class="card card-lock">
              <div class="author">
                <img class="avatar" src="/img/faces/face-2.jpg" alt="..." />
              </div>
              <h4>Chet Faker</h4>
